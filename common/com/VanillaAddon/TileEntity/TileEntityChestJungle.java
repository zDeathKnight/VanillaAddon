...
import com.VanillaAddon.block.BlockChestJungle;
...
public class TileEntityChestJungle extends TileEntity implements IInventory
{
    ...
    public TileEntityChestJungle adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestJungle adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestJungle adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestJungle adjacentChestZPosition;
    ...
    private void func_90009_a(TileEntityChestJungle par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityChestJungle)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityChestJungle)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityChestJungle)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (TileEntityChestJungle)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof BlockChestJungle ? ((BlockChestJungle)block).isTrapped == this.func_98041_l() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof BlockChestJungle)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int func_98041_l()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockChestJungle))
            {
                return 0;
            }

            this.field_94046_i = ((BlockChestJungle)this.getBlockType()).isTrapped;
        }
