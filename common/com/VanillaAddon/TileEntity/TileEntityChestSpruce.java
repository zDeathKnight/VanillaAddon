...
import com.VanillaAddon.block.BlockChestSpruce;
...
public class TileEntityChestSpruce extends TileEntity implements IInventory
{
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof BlockChestSpruce ? ((BlockChestSpruce)block).isTrapped == this.func_98041_l() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof BlockChestSpruce)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int func_98041_l()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockChestSpruce))
            {
                return 0;
            }

            this.field_94046_i = ((BlockChestSpruce)this.getBlockType()).isTrapped;
        }
