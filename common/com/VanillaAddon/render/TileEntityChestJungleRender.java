...
public class TileEntityChestJungleRender extends TileEntitySpecialRenderer
{
    ...
    public TileEntityChestJungleRender()
    {
     ...
     */
    public void renderTileEntityChestAt(TileEntityChestJungle par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockChestJungle && i == 0)
            {
                try
                {
                    ((BlockChestJungle)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                {
                    this.bindTextureByName("/mods/VanillaAddon/textures/blocks/Jungle_chest.png");
                }
            }
            else
            {
                ...
                {
                    this.bindTextureByName("/mods/VanillaAddon/textures/blocks/Jungle_largechest.png");
                }
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntityChestJungle)par1TileEntity, par2, par4, par6, par8);
    }
}
