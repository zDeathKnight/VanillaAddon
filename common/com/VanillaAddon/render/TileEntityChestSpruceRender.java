    ...
    public void renderTileEntityChestAt(TileEntityChestSpruce par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                {
                    this.bindTextureByName("/mods/VanillaAddon/textures/blocks/spruce_chest.png");
                }
            }
            else
            {
                ...
                {
                    this.bindTextureByName("/mods/VanillaAddon/textures/blocks/spruce_largechest.png");
                }
            }
